...
def sort(work_path):
    ...
    try:
        ...
        return "Change is not allowed. Close the target folder or its subfolders in all other applications."
...
if __name__ == "__main__":
    ...
    parser.add_argument("--translit", "-t", help="Translit namess", default )
